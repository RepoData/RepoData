...
Expects an Excel file generated by ArcGIS.

Args:
    geodata_path (string): pathname of the Excel file containing geodata

Attributes:
    LAT_IDX (int): index of the column in the Excel spreadsheet containing
        latitude data.
    LONG_IDX (int): index of the column in the Excel spreadsheet containing
        longitude data.
    CONF_IDX (int): index of the colum in the Excel spreadsheet containing
        geocoding confidence data.
    ID_IDX (int):index of the colum in the Excel spreadsheet containing
